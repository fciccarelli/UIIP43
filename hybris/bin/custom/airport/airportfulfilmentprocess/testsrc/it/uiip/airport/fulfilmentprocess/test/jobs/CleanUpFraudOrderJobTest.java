 ...
 */
package it.uiip.airport.fulfilmentprocess.test.jobs;
...
import it.uiip.airport.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AirportFulfilmentProcessConstants.ORDER_PROCESS_NAME;
