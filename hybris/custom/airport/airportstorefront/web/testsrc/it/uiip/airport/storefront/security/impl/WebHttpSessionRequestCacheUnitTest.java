...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/airportstorefront/electronics/en",
						"https://electronics.local:9002/airportstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/airportstorefront/electronics/en",
						"https://electronics.local:9002/airportstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/airportstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/airportstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/airportstorefront/electronics/en",
						"https://electronics.local:9002/airportstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/airportstorefront",
						"https://electronics.local:9002/airportstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/airportstorefront",
						"https://electronics.local:9002/airportstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/airportstorefront/electronics/en",
						"https://electronics.local:9002/airportstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
