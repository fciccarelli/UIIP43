 ...
 */
package it.uiip.airport.test.setup;
...
import it.uiip.airport.test.constants.AirportTestConstants;
import it.uiip.airport.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AirportTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/airporttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/airporttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/airporttest/import/cstickets.impex");
			...
			importImpexFile(context, "/airporttest/import/csquotes.impex");
		}
	}
}
