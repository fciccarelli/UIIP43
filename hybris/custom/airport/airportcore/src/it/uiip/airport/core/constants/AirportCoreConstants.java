...
/**
 * Global class for all AirportCore constants. You can add global constants for your extension into this class.
 */
public final class AirportCoreConstants extends GeneratedAirportCoreConstants
{
	public static final String EXTENSIONNAME = "airportcore";


	private AirportCoreConstants()
	{
		//empty
	}
