 ...
 */
package it.uiip.airport.core.suggestion;
...
import it.uiip.airport.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/airportcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
