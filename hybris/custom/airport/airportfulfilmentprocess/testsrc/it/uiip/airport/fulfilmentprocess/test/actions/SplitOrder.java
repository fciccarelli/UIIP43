 ...
 */
package it.uiip.airport.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AirportFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AirportFulfilmentProcessConstants.PARENT_PROCESS);
