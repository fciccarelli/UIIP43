...
public abstract class GeneratedPlane extends GenericItem
{
	...
	**/
	 ...
	 * @return the code - id Primary key  of the plane
	 */
	 ...
	 * @param value the code - id Primary key  of the plane
	 */
	...
	{
		return (List<Flight>)FLIGHTSHANDLER.getValues( ctx, this );
	}
	 ...
	 * @return the nGoods - Attribute number of goods of the plane
	 */
	 ...
	 * @param value the nGoods - Attribute number of goods of the plane
	 */
	 ...
	 * @return the nPassengers - attribute number of passengers of the plane
	 */
	 ...
	 * @param value the nPassengers - attribute number of passengers of the plane
	 */
