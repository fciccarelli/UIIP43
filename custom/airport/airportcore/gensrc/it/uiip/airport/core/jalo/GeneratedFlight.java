...
public abstract class GeneratedFlight extends GenericItem
{
	...
	/** Qualifier of the <code>Flight.arrivalAirport</code> attribute **/
	...
	**/
	...
	/**
	* {@link BidirectionalOneToManyHandler} for handling 1:n ARRIVALAIRPORT's relation attributes from 'one' side.
	**/
	protected static final BidirectionalOneToManyHandler<GeneratedFlight> ARRIVALAIRPORTHANDLER = new BidirectionalOneToManyHandler<GeneratedFlight>(
	AirportCoreConstants.TC.FLIGHT,
	false,
	"arrivalAirport",
	null,
	...
	static
	{
		...
		tmp.put(ARRIVALAIRPORT, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Flight.arrivalAirport</code> attribute.
	 * @return the arrivalAirport
	 */
	public Airport getArrivalAirport(final SessionContext ctx)
	{
		return (Airport)getProperty( ctx, ARRIVALAIRPORT);
	}
	...
	{
		return getArrivalAirport( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Flight.arrivalAirport</code> attribute. 
	 * @param value the arrivalAirport
	 */
	public void setArrivalAirport(final SessionContext ctx, final Airport value)
	{
		ARRIVALAIRPORTHANDLER.addValue( ctx, value, this  );
	}
	 ...
	 * @param value the arrivalAirport
	 */
	public void setArrivalAirport(final Airport value)
	{
		setArrivalAirport( getSession().getSessionContext(), value );
	}
	...
	protected Item createItem(final SessionContext ctx, final ComposedType type, final ItemAttributeMap allAttributes) throws JaloBusinessException
	{
		...
		ARRIVALAIRPORTHANDLER.newInstance(ctx, allAttributes);
